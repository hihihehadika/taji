 ...
 * @param {string} input_mentah
 */
export function atur_antrian_masukan(input_mentah) {
    const ptr0 = passStringToWasm0(input_mentah, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.atur_antrian_masukan(ptr0, len0);
}
 ...
 * @param {string} kode_sumber
 * @returns {string}
 */
export function jalankan_taji(kode_sumber) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(kode_sumber, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.jalankan_taji(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('taji_lib_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
